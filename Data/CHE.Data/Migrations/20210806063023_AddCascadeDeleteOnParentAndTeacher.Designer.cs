...
namespace CHE.Data.Migrations
{
    ...
    [Migration("20210806063023_AddCascadeDeleteOnParentAndTeacher")]
    partial class AddCascadeDeleteOnParentAndTeacher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CHE.Data.Models.Message", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CHE.Data.Models.Messenger", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CHE.Data.Models.MessengerUser", b =>
                {
                    b.Property<string>("MessengerId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("MessengerId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("MessengersUsers");
                });
            ...
            modelBuilder.Entity("CHE.Data.Models.Message", b =>
                {
                    b.HasOne("CHE.Data.Models.Messenger", "Messenger")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("CHE.Data.Models.Messenger", b =>
                {
                    b.HasOne("CHE.Data.Models.Cooperative", "Cooperative")
                        .WithOne("Messenger")
                        .HasForeignKey("CHE.Data.Models.Messenger", "CooperativeId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("CHE.Data.Models.Parent", b =>
                {
                    b.HasOne("CHE.Data.Models.CheUser", "User")
                        .WithOne("Parent")
                        .HasForeignKey("CHE.Data.Models.Parent", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("CHE.Data.Models.Teacher", b =>
                {
                    b.HasOne("CHE.Data.Models.CheUser", "User")
                        .WithOne("Teacher")
                        .HasForeignKey("CHE.Data.Models.Teacher", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
