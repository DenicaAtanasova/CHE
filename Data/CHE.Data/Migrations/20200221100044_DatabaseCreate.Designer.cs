...
namespace CHE.Data.Migrations
{
    ...
    [Migration("20200221100044_DatabaseCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CHE.Data.Models.CheUser", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("CheUser");
                });
            ...
            modelBuilder.Entity("CHE.Data.Models.JoinRequest", b =>
                {
                    ...
                    b.Property<string>("CoopReceiverId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("CoopSenderId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ParentSenderId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("TeacherReceiverId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("CoopReceiverId");

                    b.HasIndex("CoopSenderId");

                    b.HasIndex("ParentSenderId");

                    b.HasIndex("TeacherReceiverId");
            ...
            modelBuilder.Entity("CHE.Data.Models.VCard", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CHE.Data.Models.VCardGrade", b =>
                {
                    b.Property<string>("VCardId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("GradeId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("VCardId", "GradeId");

                    b.HasIndex("GradeId");

                    b.ToTable("VCardGrades");
                });
            ...
            modelBuilder.Entity("CHE.Data.Models.Parent", b =>
                {
                    b.HasBaseType("CHE.Data.Models.CheUser");
            ...
            modelBuilder.Entity("CHE.Data.Models.JoinRequest", b =>
                {
                    b.HasOne("CHE.Data.Models.Cooperative", "CoopReceiver")
                        .WithMany("ReceivedJoinRequests")
                        .HasForeignKey("CoopReceiverId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CHE.Data.Models.Cooperative", "CoopSender")
                        .WithMany("SentJoinRequests")
                        .HasForeignKey("CoopSenderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CHE.Data.Models.Parent", "ParentSender")
                        .WithMany("SentJoinRequests")
                        .HasForeignKey("ParentSenderId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CHE.Data.Models.Teacher", "TeacherReceiver")
                        .WithMany("ReceivedJoinRequests")
                        .HasForeignKey("TeacherReceiverId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("CHE.Data.Models.VCardGrade", b =>
                {
                    ...
                    b.HasOne("CHE.Data.Models.VCard", "VCard")
                        .WithMany("Grades")
            ...
            modelBuilder.Entity("CHE.Data.Models.Teacher", b =>
                {
                    b.HasOne("CHE.Data.Models.VCard", "VCard")
                        .WithOne("Owner")
                        .HasForeignKey("CHE.Data.Models.Teacher", "VCardId");
                });
